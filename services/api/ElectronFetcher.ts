...
> implements IResourceFetcher<TResourceType, TContentMeta, TDetailMeta>
{
  ...
  async getResourcesSummary(): Promise<{
    ...
    console.log(
      `[ElectronFetcher] getResourcesSummary for ${this.resourceType}`
    );
  ...
  async getResourceIds(): Promise<{ ids: string[] }> {
    console.log(`[ElectronFetcher] getResourceIds for ${this.resourceType}`);
  ...
  async getResources(
    ...
    console.log(
      `[ElectronFetcher] getResources for ${this.resourceType}, page=${page}, pageSize=${pageSize}`
    );
  ...
  async getResource(resourceId: string): Promise<any | null> {
    console.log(
      `[ElectronFetcher] getResource(${resourceId}) for ${this.resourceType}`
    );
  ...
  async deleteResource(resourceId: string): Promise<void> {
    console.log(
      `[ElectronFetcher] deleteResource(${resourceId}) for ${this.resourceType}`
    );
  ...
  async getContent(
    ...
    console.log(
      `[ElectronFetcher] getContent(${resourceId}, ${contentId}) for ${
        this.resourceType
  ...
  async getThumbnail({
    ...
    console.log(
      `[ElectronFetcher] getThumbnail(${resourceId}) for ${this.resourceType}, size=${size}`
    );
    return Promise.resolve(null);
  }

  async addResource(formData: FormData): Promise<AddResourceSuccessResponse> {
    console.log(`[ElectronFetcher] addResource for ${this.resourceType}`);
    return Promise.resolve({
      status: "success",
  ...
  async updateResource(
    ...
    console.log(
      `[ElectronFetcher] updateResource(${resourceId}) for ${this.resourceType}`
    );
    return Promise.resolve({
      status: "success",
      message: "Not implemented",
  ...
  async addResourceContent(
    ...
    console.log(
      `[ElectronFetcher] addResourceContent(${resourceId}) for ${this.resourceType}`
    );
    return Promise.resolve({
      status: "success",
      message: "Not implemented",
  ...
  async updateThumbnail(
    ...
    console.log(
      `[ElectronFetcher] updateThumbnail(${resourceId}, angle=${angle}) for ${this.resourceType}`
    );
    return Promise.resolve({
      status: "success",
      message: "Not implemented",
  ...
  async updateContentExif(
    ...
    console.log(
      `[ElectronFetcher] updateContentExif(${resourceId}, ${contentId}) for ${
        this.resourceType
  ...
  getContentURL(
    ...
    console.log(
      `[ElectronFetcher] getContentURL(${resourceId}, ${contentId}, ${filename}  ) for ${
        this.resourceType
  ...
  getThumbnailURL(
    ...
    console.log(
      `[ElectronFetcher] getThumbnailURL(${resourceId}) for ${
        this.resourceType
      }, query=${JSON.stringify(query)}`
    );
    return "";
